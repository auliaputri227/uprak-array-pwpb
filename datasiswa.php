      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-th"></i> <span>Kelas</span></a>
                <ul class="dropdown-menu">
      ...
      <div class="main-content">
        <section class="section">
            <div class="container-sm">
                <!-- <h4><a class="btn btn-info mb-3" href="tambahbaru.php">[+] Tambah Produk</a></h4> -->
                <table class="table table-bordered text-center mt-4 mb-5"> 
                    <thead class="bg-info text-white">
                      ...
                      <tbody>
                        <?php $siswa = mysqli_query($conn,"SELECT * FROM siswa");
                  
                        ?>
                      <?php foreach ($siswa as $w ) :?>
                        <tr>
                            <td><?php echo $w['id_siswa']  ?></td>
                            <td><?php echo $w['nama_siswa']  ?></td>
                            <td><?php echo $w['tempat_lahir']  ?></td>
                            <td><?php echo $w['tgl_lahir']  ?></td>
                            <td><?php echo $w['jk']  ?></td>
                            <td><?php echo $w['umur']  ?></td>
                            <td><img src="<?php echo $w['foto']  ?>" alt="image" width='100' height='100'></td>
                            <td>
                            <a class='btn btn-primary' href="editsiswa.php?id_siswa=<?php echo $w['id_siswa'] ?>">Edit</a> 
                            <a class='btn btn-danger' href="hapussiswa.php?id_siswa=<?php echo $w['id_siswa'] ?>">Hapus</a> 
                            </td>
                          </tr>  
                        <?php endforeach; ?>
                      </tbody>
                ...
                <a href="rpl1.php" class="btn btn-primary ml-3">Back</a>
            </div>
        </section>
      </div>
      <!-- end content -->
