...
if(isset($_POST["login"])){
  ...
  if($username === "admin" &&  $password === "123"){
    ...
    echo"<script>alert('Masukan username dan password yang benar !!')</script>;";
    }
  }
?>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="card card-primary">
              <div class="card-header text-center"><h4>PORTAL SMK TB</h4></div>
              <div class="card-body">
                <form  action="" method="POST" class="needs-validation" novalidate="">
                <input type="hidden" hidden name="id" value="<?= $siswa['id'] ?>">
                ...
                <div class="row sm-gutters mt-2">
                  ...
                  <div class="col-6">
                    <a class="btn btn-block btn-social btn-instagran">
            ...
            <div class="text-center mt-5"><h4>PORTAL SMK TB</h4></div>
            <div class="simple-footer text-center">
              Copyright By Aulia Putri
            </div>
          </div>
        </div>
      </div>
