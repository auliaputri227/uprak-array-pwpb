        ...
        <div class="row">
            <div class="container" style="margin-top:70px">
                <div class="container mt-4 ml-5 justify-content-center">
                    <div class="card">
                        <h4 class="mt-4 text-black text-center">Detail Data Siswa</h4>
                        <div class="card-body">
                            <form action="simpanmandiri.php" method="post">
                            <input type="hidden" hidden name="id_siswa" value="<?= $siswa['id_siswa'] ?>">
                                <div class="form-group row justify-content-center">
                                    <label for="" class="col-sm-3 col-form-label">Nama</label>
                                    <div class="col-sm-6">
                                        <input type="text" name="nama_siswa" class="col-md-9" value="<?= $siswa['nama_siswa'] ?>">
                                    </div>
                                </div>
                                ...
                                <a href="rpl1.php" class="btn btn-primary ml-2">Back</a>
                            </form>
                        </div>
                    </div>
                </div>
