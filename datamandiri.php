      ...
      <div class="main-content">
        <section class="section">
            <div class="container-sm">
                ...
                <?php
                    // $sql = mysqli_query($conn,"SELECT * FROM siswa WHERE 'id_siswa' = '$siswa'");
                    // $ambil = $conn->query("SELECT * FROM produk WHERE id_produk = '$id_prod'");
                    // $siswa = $sql->fetch_assoc();
                    ?>
                <table class="table table-bordered text-center mt-4 mb-5"> 
                    <thead class="bg-info text-white">
                        <tr>
                            <th>No<?= $siswa['id_siswa']?></th>
                            <th>Nama<?= $siswa['nama_produk'] ?></th>
                            <th>Tempat Lahir<?= $siswa['tempat_lahir'] ?></th>
                            <th>Tanggal Lahir<?= $siswa['tgl_lahir'] ?></th>
                            <th>Jenis Kelamin<?= $siswa['jk'] ?></th>
                            <th>Umur<?= $siswa['umur'] ?></th>
                            <th>Foto<?= $siswa['foto'] ?></th>
                        </tr>
                    </thead>
